...
private:
   ...
   static TFile *OpenFromCache(const char *name, Option_t * = "",
                               const char *ftitle = "", Int_t compress =  static_cast<int>(ROOT::RCompressionSetting::EDefaults::kUseGeneralPurpose),
                               Int_t netopt = 0);
...
public:
   ...
   TFile();
   TFile(const char *fname, Option_t *option="", const char *ftitle="", Int_t compress =  static_cast<int>(ROOT::RCompressionSetting::EDefaults::kUseGeneralPurpose));
   virtual ~TFile();
   ...
   virtual void        SetCompressionAlgorithm(Int_t algorithm = static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kUseGlobal));
   virtual void        SetCompressionLevel(Int_t level = static_cast<int>(ROOT::RCompressionSetting::ELevel::kUseMin));
   virtual void        SetCompressionSettings(Int_t settings = static_cast<int>(ROOT::RCompressionSetting::EDefaults::kUseGeneralPurpose));
...
private:
   ...
   TFileOpenHandle(TFile *f) : TNamed("",""), fOpt(""), fCompress( static_cast<int>(ROOT::RCompressionSetting::EDefaults::kUseGeneralPurpose)),
                               fNetOpt(0), fFile(f) { }
