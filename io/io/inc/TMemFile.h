...
public:
   TMemFile(const char *name, Option_t *option="", const char *ftitle="", Int_t compress =  static_cast<int>(ROOT::RCompressionSetting::EDefaults::kUseGeneralPurpose));
   TMemFile(const char *name, char *buffer, Long64_t size, Option_t *option="", const char *ftitle="", Int_t compress =  static_cast<int>(ROOT::RCompressionSetting::EDefaults::kUseGeneralPurpose));
