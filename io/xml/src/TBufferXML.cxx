...
{
   if (algorithm < 0 || algorithm >= static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kUndefined))
      algorithm = 0;
   if (fCompressLevel < 0) {
      fCompressLevel = 100 * algorithm + static_cast<int>(ROOT::RCompressionSetting::ELevel::kUseMin);
   } else {
