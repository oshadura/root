...
public:
   TXMLFile();
   TXMLFile(const char *filename, Option_t *option = "read", const char *title = "title", Int_t compression = static_cast<int>(ROOT::RCompressionSetting::EDefaults::kUseGeneralPurpose));
   virtual ~TXMLFile();
