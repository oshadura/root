...
TUDPSocket::TUDPSocket(TInetAddress addr, const char *service)
         : TNamed(addr.GetHostName(), service), fCompress(static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kUseGlobal))
{
   R__ASSERT(gROOT);
   R__ASSERT(gSystem);
...
TUDPSocket::TUDPSocket(TInetAddress addr, Int_t port)
         : TNamed(addr.GetHostName(), ""), fCompress(static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kUseGlobal))
{
   R__ASSERT(gROOT);
   R__ASSERT(gSystem);
...
TUDPSocket::TUDPSocket(const char *host, const char *service)
         : TNamed(host, service), fCompress(static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kUseGlobal))
{
   R__ASSERT(gROOT);
   R__ASSERT(gSystem);
...
TUDPSocket::TUDPSocket(const char *url, Int_t port)
         : TNamed(TUrl(url).GetHost(), ""), fCompress(static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kUseGlobal))
{
   R__ASSERT(gROOT);
   R__ASSERT(gSystem);
...
TUDPSocket::TUDPSocket(const char *sockpath) : TNamed(sockpath, ""),
                                               fCompress(static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kUseGlobal))
{
   R__ASSERT(gROOT);
   R__ASSERT(gSystem);
...
TUDPSocket::TUDPSocket(Int_t desc) : TNamed("", ""), fCompress(static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kUseGlobal))
{
   R__ASSERT(gROOT);
   R__ASSERT(gSystem);
...
{
   if (algorithm < 0 || algorithm >= static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kUndefined)) algorithm = 0;
   if (fCompress < 0) {
      // if the level is not defined yet use 4 as a default (with ZLIB was 1)
      fCompress = 100 * algorithm + static_cast<int>(ROOT::RCompressionSetting::ELevel::kUseMin);
   } else {
...
void TUDPSocket::SetCompressionLevel(Int_t level)
{
   ...
   if (fCompress < 0) {
      ...
      if (algorithm >= static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kUndefined)) algorithm = 0;
      fCompress = 100 * algorithm + level;
   }
}
