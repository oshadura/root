...
public:
   TParallelMergingFile(const char *filename, Option_t *option = "", const char *ftitle = "", Int_t compress =  static_cast<int>(ROOT::RCompressionSetting::EDefaults::kUseGeneralPurpose));
   ~TParallelMergingFile();
