...
macro(generate_package_manifest name)
  file(WRITE "${CMAKE_CURRENT_SOURCE_DIR}/package.yml" "package: \n    name: " \"${name}\" \n )
  file(APPEND "${CMAKE_CURRENT_SOURCE_DIR}/package.yml" "    tag: 0.0.0" \n)
  file(APPEND "${CMAKE_CURRENT_SOURCE_DIR}/package.yml" "    targets:\n")
  file(APPEND "${CMAKE_CURRENT_SOURCE_DIR}/package.yml" "      target:\n")
  file(APPEND "${CMAKE_CURRENT_SOURCE_DIR}/package.yml" "\tname: \"${name}\"\n")
  file(APPEND "${CMAKE_CURRENT_SOURCE_DIR}/package.yml" "    products:\n")
  file(APPEND "${CMAKE_CURRENT_SOURCE_DIR}/package.yml" "      package:\n")
  file(APPEND "${CMAKE_CURRENT_SOURCE_DIR}/package.yml" "\tname: ${name}\n")
endmacro()
