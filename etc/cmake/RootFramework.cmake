...
macro(generate_module_manifest libname dlist srclist hdrlist)
  ...
  file(APPEND "${CMAKE_CURRENT_SOURCE_DIR}/${libname}${libname}module.yml" " packageurl: " \"https://github.com/root-project/${pkgname}\"\n)
  ...
  file(APPEND "${CMAKE_CURRENT_SOURCE_DIR}/${libname}module.yml" " deps: " "${dlist}\n")
