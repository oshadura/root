...
public:
   TBranch();
   TBranch(TTree *tree, const char *name, void *address, const char *leaflist, Int_t basketsize=32000, Int_t compress = static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kInherit));
   TBranch(TBranch *parent, const char *name, void *address, const char *leaflist, Int_t basketsize=32000, Int_t compress = static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kInherit));
   virtual ~TBranch();
   ...
   void              SetCompressionAlgorithm(Int_t algorithm = static_cast<int>(ROOT::RCompressionSetting::EAlgorithm::kUseGlobal));
   void              SetCompressionLevel(Int_t level = static_cast<int>(ROOT::RCompressionSetting::ELevel::kUseMin));
   void              SetCompressionSettings(Int_t settings = static_cast<int>(ROOT::RCompressionSetting::EDefaults::kUseGeneralPurpose));
